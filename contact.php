    ...
    <section class="checkout-grid">
        ...
        <article class="glass">
            ...
            <div class="faq">
                ...
                <div class="faq-answer"><p>Yes, at the cinema counter before showtime (demo policy).</p></div>
                <button class="faq-question" type="button">Do you support card payment online?</button>
                <div class="faq-answer"><p>This static version is frontend-only.</p></div>
                <button class="faq-question" type="button">Can I reserve for a friend?</button>
                <div class="faq-answer"><p>Yes, use their name and phone during checkout.</p></div>
            </div>
        </article>
    </section>
</main>
